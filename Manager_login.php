...
<body>
    ...
    <nav>
        ...
        <a target="iframe" class="c1" onclick="funcUpdeteContent()">Update Content</a></br></br>
        <a target="iframe" class="c1" onclick="funcSView()">View Orders</a><br><br>
        <a target="iframe" class="c1" onclick="funcVCustomer()">View Customer</a></br></br>
        <a target="iframe" class="c1" onclick="funcSalesman()">View Salesman</a></br></br>
        <a target="iframe" class="c1" onclick="funcFeedback()">View Feedback</a></br></br>
    </nav>
    ...
    <script>
        ...
        function funcVCustomer() {
            document.getElementById("iframe").src = "ViewCustomer.php";
        }
        function funcSalesman() {
            document.getElementById("iframe").src = "ViewSalesman.php";
        }
        function funcFeedback() {
